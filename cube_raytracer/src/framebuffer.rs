...
impl Framebuffer {
    ...
    pub fn clear(&mut self) {
        ...
        // Alternativa (si prefieres no re-alocar):
    ...
    pub fn set_background_color(&mut self, color: Color) {
        self.background_color = color; // <- FIX correcto
    }
